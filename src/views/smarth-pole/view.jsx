...
class ViewComponent extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            currtenthumid: null,
            data_from_fetch: [],
            itemSelectByDropdown: {'name': 'batt' ,'item' :'batt_soc' },
    ...
    onDropdownChange = (e) => {
        ...
        this.setState({   itemSelectByDropdown : e.value})
    ...
    ChartprimeLine = () => {
        ...
        const itemselectbydropdown = this.state.itemSelectByDropdown.item;
        const timestamp = [];
        const data = [];
        ...
        if (!loading) {
            ...
            dataformfetch.map(item => {
                    const dataSelectByDropDown = [];
                    item.map(item => (
                        dataSelectByDropDown.push(item[itemselectbydropdown])
                    ))
                    data.push({ label: item[0].devices.device_name, data: dataSelectByDropDown, fill: false, tension: 0.4 })
                })
    ...
    render() {
        ...
        const dropdownItem = [{ 'name': 'batt' ,'item' :'batt_soc' }, { 'name': 'pm2.5','item' :'pm2_5' }, { 'name': 'rain','item' :'rain_sensor' }, { 'name': 'sound','item' :'sound_sensor' }, { 'name': 'temp','item' :'temp' }]
        const optionItem = [{id:1,optionName:'batt'},]
        return (
                    ...
                    <Grid item xs={12} sm={12} >
                        <Card>
                            <div style={{ position: "relative", top: "-20px", marginBottom: "2rem" }}>
                                <Dropdown 
                                value={this.state.itemSelectByDropdown} 
